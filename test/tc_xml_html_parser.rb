...
class TC_XML_HTMLParser < Test::Unit::TestCase
  ...
  def test_libxml_html_parser_parse()
    ...
    assert_instance_of LibXML::Node, hello
    assert_equal 'Hello', hello.content

    br = hello.next
    assert_instance_of LibXML::Node, br
    assert_equal 'br', br.name

    world = br.next
    assert_instance_of LibXML::Node, world
