...
which includes  binary files for Ruby 1.8 and Ruby 1.9.  The binaries
are built against libxml2 version 2.7.8, iconv version 1.13 and zlib
version 1.2.5.

The Windows binaries are built with MingW and include libxml-ruby, 
libxml2 and iconv.  The gem also includes a Microsoft VC++ 2010
